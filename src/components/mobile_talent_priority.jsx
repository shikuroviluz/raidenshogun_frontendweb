...
function Mobile_talent(){
    return(
    <>
    <h1 className="text-2xl mb-5 font-genshin">Talent Priority</h1>
    <div className="flex flex-col justify-center items-center mb-5">
        <div className="grid grid-cols-2 divide-white border-2 text-center">
            ...
            <div className="flex flex-col items-center justify-center p-3 border-2 border-white">
                <img src={burstQ} alt="sands" className="w-15 rounded-2xl"/>
            </div>
            <div className="flex flex-col items-center justify-center p-3 border-2 border-white">
        ...
        {/* baris 2 */}
            <div className="flex flex-col items-center justify-center p-3 border-2 border-white">
                <img src={skillE} alt="circlet" className="w-15 rounded-2xl"/>
            </div>
            <div className="flex flex-col items-center justify-center p-3 border-2 border-white">
            ...
            <div className="flex flex-col items-center justify-center p-3 border-2 border-white">
                <img src={baseatk} alt="circlet" className="w-15 rounded-2xl"/>
            </div>
            <div className="flex flex-col items-center justify-center p-3 border-2 border-white">
