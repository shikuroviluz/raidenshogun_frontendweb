...
function Friend(){
        ...
        <div className="relative w-full h-full my-auto">
            ...
            <div className="absolute inset-0 z-10 flex items-center px-10">
                <div className="text-white max-w-xl flex flex-col">
                    <h1 className="text-5xl font-genshin" data-aos="fade-right" data-aos-duration="1000">Yaemiko's best Friend</h1>
                    ...
                    <a href="#Yaemiko" target="_blank" rel="noopener noreferrer" data-aos="fade-up" data-aos-duration="1500">
    ...
    <div className="md:hidden">
        <div className="flex flex-col items-center gap-3 p-4">
            <h1 className="text-2xl font-genshin">Yaemiko's best Friend</h1>
            ...
            <a href="#Yaemiko" target="_blank" rel="noopener noreferrer" data-aos="fade-up" data-aos-duration="1500">
                <div className="flex items-center justify-center relative w-45 h-10 hover:scale-105 transition duration-300 bg-purple-700 p-4 rounded-2xl hover:bg-pink-600 text-[9px]">
                    About YaeMiko
                </div>
            </a>
        </div>
