...
function Detail() {
  ...
  <div className="flex flex-col justify-center gap-3 p-4">
    ...
    <div
      className="h-[2px] w-80 sm:w-90 bg-white mb-3 ml-auto"
      data-aos="fade-up"
    ...
    >
      <p className="text-[13px] opacity-80 text-right bg-black/60 text-white px-4 py-4 rounded-lg">
        perwujudan kekuatan petir yang merupakan penguasa tertinggi Inazuma dan
        Dewa Keabadian, yang sebenarnya terdiri dari dua entitas: Raiden Ei
        (Archon asli) dan Shogun (boneka mekanik ciptaan Ei untuk memerintah
    ...
    <div>
      ...
      <div
        className="mt-4 flex gap-3 mx-auto"
        data-aos="fade-up"
